...
class Index extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Magenest_CacheWarmer::url_queue');
        $resultPage->addBreadcrumb(__('Ur Queue'), __('Url Queue'));
        $resultPage->getConfig()->getTitle()->prepend(__('Url Queue'));
